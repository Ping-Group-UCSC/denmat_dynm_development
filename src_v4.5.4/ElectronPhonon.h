...
public:
	...
	double prefac_gauss, prefac_sqrtgauss, prefac_eph, scale_eph;
		...
		dP1ee(nullptr), dP2ee(nullptr)
	{
		...
		for (int iD = 0; iD < eip.ni.size(); iD++){
			eimp[iD] = new electronimpurity(iD, mp, isHole, nkpair_glob, nb, latt->volume);
