...
public:
	...
	{
		//this->e = trunc_alloccopy_array(e_extend, nk_glob, bStart, bEnd);
...
void phenom_relax::evolve_driver(double t, complex **dm_extend, complex **dm_eq_extend, complex **ddmdt_phenom_extend){
	trunc_copy_array(dm, dm_extend, nk_glob, nb_dm, bStart, bEnd);
	trunc_copy_array(dm_eq, dm_eq_extend, nk_glob, nb_dm, bStart, bEnd);
