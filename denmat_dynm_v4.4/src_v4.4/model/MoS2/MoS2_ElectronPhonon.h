...
public:
	...
	eph_model_MoS2(lattice_MoS2 *latt, parameters *param, elec_model_MoS2 *elec_mos2, ph_model_MoS2 *ph_mos2, bool sepr_eh = false, bool isHole = false)
		: latt(latt), electronphonon(param), elec_mos2(elec_mos2), ph_mos2(ph_mos2),
