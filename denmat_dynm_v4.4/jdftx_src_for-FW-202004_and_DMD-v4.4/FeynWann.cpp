...
: fwp(fwp), nAtoms(0), nSpins(0), nSpinor(0), spinWeight(0), isMetal(false), mu(NAN), nElectrons(0), eEneOnly(false),
polar(false), ePhEstart(0.), ePhEstop(0.), tTransformByCompute(1), inEphLoop(false)
{	
