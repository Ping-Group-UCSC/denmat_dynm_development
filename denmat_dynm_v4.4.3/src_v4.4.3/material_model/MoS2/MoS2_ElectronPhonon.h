...
class eph_model_MoS2 :public electronphonon{
public:
	mymp *mp;
	lattice_MoS2 *latt;
	elec_model_MoS2 *elec_mos2;
	ph_model_MoS2 *ph_mos2;
	const double prefac_g, xita,xila, d1tainter, d1lainter, d1tointra, d1tointer, d0lointer, gfr, halfdfr;

	eph_model_MoS2(mymp *mp, lattice_MoS2 *latt, parameters *param, elec_model_MoS2 *elec_mos2, ph_model_MoS2 *ph_mos2, bool sepr_eh = false, bool isHole = false)
		:mp(mp), latt(latt), electronphonon(param), elec_mos2(elec_mos2), ph_mos2(ph_mos2),
