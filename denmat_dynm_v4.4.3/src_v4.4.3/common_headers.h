...
public:
	...
	bool expt, expt_elight, ddmeq, summode, eph_sepr_eh, eph_need_elec, eph_need_hole, sparseP, Pin_is_sparse, set_scv_zero;
	bool modelH0hasBS, eph_enable, phenom_relax, only_eimp, only_ee, only_intravalley, only_intervalley;
